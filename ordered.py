...
#Train agent to find a three packages in order   
...
def reward(old_pos, new_pos, cell, found):
    if old_pos == new_pos: #Punish running into boundaries
        return -7500
    if (cell == 1 and found == 0): #Reward finding package in correct order
        return 100000
    elif (cell == 2 and found == 1):
        return 100000
    elif (cell == 3 and found == 2):
        return 100000    
    elif (cell > 0): #Avoid collecting in wrong order
        return -7000 
